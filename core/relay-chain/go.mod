module github.com/Shivam-Patel-G/blackhole-blockchain/core/relay-chain
...
// grpc package in this module is unused dead code — ignore its test deps
// by using the ignore build tag approach via go.work or explicit build paths.
