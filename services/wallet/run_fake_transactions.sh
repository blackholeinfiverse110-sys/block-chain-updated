...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "📝 Usage: ./run_fake_transactions.sh <peer_address> [rate]"
    echo "📝 Example: ./run_fake_transactions.sh /ip4/127.0.0.1/tcp/3000/p2p/12D3KooWEHMeACYKmddCU7yvY7FSN78CnhC3bENFmkCcouwu1z8R 4.0"
    echo ""
